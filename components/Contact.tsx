        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-12 md:gap-24 items-start">
            ...
            <div className="lg:col-span-5 text-center lg:text-right" dir="rtl">
              ...
              <h2 className="text-4xl md:text-6xl lg:text-7xl font-black mb-6 md:mb-8 text-white tracking-tighter leading-[1.1]">
              ...
              <div className="space-y-4 text-right">
                {contactMethods.map((method, i) => (
                  <a
                    ...
                    className="flex items-center gap-4 md:gap-6 p-5 md:p-6 rounded-[2rem] bg-slate-900/30 border border-white/5 hover:border-indigo-500/30 hover:bg-slate-900/50 transition-all group backdrop-blur-sm"
                  >
                    <div className={`w-12 h-12 md:w-14 md:h-14 ${method.bg} rounded-2xl flex items-center justify-center ${method.color} group-hover:scale-110 transition-transform shadow-lg shadow-black/20 shrink-0`}>
                      <method.icon size={22} className="md:w-6 md:h-6" />
                    </div>
              ...
              <div className="mt-10 md:mt-12 p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] bg-gradient-to-br from-emerald-500/10 to-transparent border border-emerald-500/20 relative overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                  ...
                  <a
                    href={whatsappUrl}
                    target="_blank"
                    className="w-full md:w-auto bg-emerald-500 hover:bg-emerald-400 text-slate-950 px-8 py-4 rounded-2xl font-black text-sm flex items-center justify-center gap-3 shadow-2xl shadow-emerald-500/20 transition-all active:scale-95 whitespace-nowrap"
                  >
                    تحدث معي الآن
            ...
            <div className="lg:col-span-7 w-full">
              <div className="p-8 md:p-12 lg:p-16 rounded-[2.5rem] md:rounded-[4rem] bg-slate-900/50 border border-white/5 backdrop-blur-3xl relative overflow-hidden shadow-3xl">
                ...
                <div className="relative z-10">
                  ...
                  <form className="space-y-8 text-right" dir="rtl">
                    <div className="space-y-3">
                      <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest pr-2">الاسم الكامل</label>
                      <input
                        type="text"
                        className="w-full bg-slate-950/80 border border-white/10 rounded-[var(--border-radius-elite)] px-6 py-5 text-sm text-white focus:border-[var(--accent-indigo)] focus:bg-slate-950 outline-none transition-all shadow-inner"
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <select className="w-full bg-slate-950/80 border border-white/10 rounded-[var(--border-radius-elite)] px-6 py-5 text-sm text-white focus:border-[var(--accent-indigo)] focus:bg-slate-950 outline-none appearance-none transition-all cursor-pointer">
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        rows={6}
                        className="w-full bg-slate-950/80 border border-white/10 rounded-[var(--border-radius-elite)] px-6 py-5 text-sm text-white focus:border-[var(--accent-indigo)] focus:bg-slate-950 outline-none transition-all shadow-inner resize-none"
                        placeholder="اشرح لنا فكرتك، المشاكل التي تواجهها، والأهداف التي تريد تحقيقها..."
                      ></textarea>
                    </div>

                    <button type="submit" className="w-full group bg-white hover:bg-[var(--accent-indigo)] text-slate-950 hover:text-white py-6 rounded-[var(--border-radius-elite)] font-black text-base flex items-center justify-center gap-4 transition-all shadow-2xl active:scale-[0.98]">
                      إرسال رسالتك الآن
